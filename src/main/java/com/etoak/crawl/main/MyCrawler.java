...
public class MyCrawler {
    ...
    public void crawling(String[] seeds) {
        ...
        while (!Links.unVisitedUrlQueueIsEmpty()  && Links.getVisitedUrlNum() <= 100000) {
            ...
            //得到超链接,可以考虑是否增加新的未访问url
            Set<String> links = PageParserTool.getLinks(page,"a");
            for (String link : links) {
                if(Links.addUnvisitedUrlQueue(link)){
                    System.out.println("新增的url: "+link);
                }
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        crawler.crawling(new String[]{"https://blog.csdn.net/forezp/article/details/70148833/"});
    }
}
