...
public class RequestAndResponseTool {
     ...
     * 
     * @param url  需要访问的地址\
     * @return 发生异常时,返回Page的contentType为unvisited,并且保存为访问的url
     */
    public static Page  sendRequstAndGetResponse(String url) {
        ...
        header.setValue("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3514.0 Safari/537.36");
        ...
        // 发生网络异常
            ...
            e.printStackTrace();
            page=new Page(null,url,"unvisit");
        } finally {
        // 释放连接
